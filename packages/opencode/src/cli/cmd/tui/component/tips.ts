export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by CoreThink Code.",
  ...
  "Create {highlight}corethink-code.json{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/corethink-code/corethink-code.json{/highlight} for global config.",
  ...
  "CoreThink Code auto-handles OAuth for remote MCP servers requiring auth.",
  "Add {highlight}.md{/highlight} files to {highlight}.corethink-code/command/{/highlight} to define reusable custom prompts.",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  "Add {highlight}.md{/highlight} files to {highlight}.corethink-code/agent/{/highlight} for specialized AI personas.",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools.",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions.',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands.',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing.',
  "CoreThink Code auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "CoreThink Code uses LSP servers for intelligent code analysis.",
  "Create {highlight}.ts{/highlight} files in {highlight}.corethink-code/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.corethink-code/plugin/{/highlight} for event hooks.",
  "Use plugins to send OS notifications when sessions complete.",
  "Create a plugin to prevent CoreThink Code from reading sensitive files.",
  "Use {highlight}corethink-code run{/highlight} for non-interactive scripting.",
  "Use {highlight}corethink-code run --continue{/highlight} to resume the last session.",
  "Use {highlight}corethink-code run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}corethink-code serve{/highlight} for headless API access to CoreThink Code.",
  "Use {highlight}corethink-code run --attach{/highlight} to connect to a running server for faster runs.",
  "Run {highlight}corethink-code upgrade{/highlight} to update to the latest version.",
  "Run {highlight}corethink-code auth list{/highlight} to see all configured providers.",
  "Run {highlight}corethink-code agent create{/highlight} for guided agent creation.",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors.',
  "Create JSON theme files in {highlight}.corethink-code/themes/{/highlight} directory.",
  ...
  "Run {highlight}corethink-code debug config{/highlight} to troubleshoot configuration.",
